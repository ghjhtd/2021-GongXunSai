...
u8 x=0,y=12;
	u8 size_last=0;
	u8 len_last=0;
	OLED_ShowNum(0,0,num[0],1,40);
	OLED_ShowNum(20,0,num[1],1,40);
	OLED_ShowNum(40,0,num[2],1,40);
	OLED_ShowNum(68,0,num[3],1,40);
  OLED_ShowNum(88,0,num[4],1,40);
	OLED_ShowNum(108,0,num[5],1,40);
//		OLED_ShowNum(68,0,COLOR[0],1,40);
//  OLED_ShowNum(88,0,COLOR[1],1,40);
//	OLED_ShowNum(108,0,COLOR[2],1,40);
	 OLED_Refresh();
