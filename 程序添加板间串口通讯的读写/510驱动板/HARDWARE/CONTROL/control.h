...
int MoveX_T(int x,int time,int zhongzhi_x);        //在x轴上以速度x移动time ms
int MoveX(int x,int count,int zhongzhi_x);        //在x轴上以速度x移动count格
int MoveY_T(int x,int time);        //在y轴上以速度x移动time ms
int MoveY(int x,int count,int zhongzhi_y);        //在y轴上以速度x移动count格
