...
extern int Position_Zero;            //编码器的脉冲计数
 extern int A_AIM,B_AIM,C_AIM,D_AIM ;                                 //电机PWM变量 应是Motor的 向Moto致敬	
extern int Voltage;                                //电池电压采样相关的变量
extern int Encoder_A,Encoder_B,Encoder_C,Encoder_D;                                                 
extern float Balance_KP, Balance_KI,Balance_KD,Position_KP,Position_KI,Position_KD;  //PID系数
extern float Velocity_KP,Velocity_KI;                                                   

extern vu16 Distance_data;
extern vu16 Distance;
extern	int PWM,PWM0,PWM1,PWM2,PWM3;
extern int CGQ[8],step,mode,num[8],num_cnt,color,color_num,COLOR[3],go;
extern  int x,y,xaim,yaim;
