...
u8 MPU_Set_LPF(u16 lpf)
{
	...
	return MPU_Write_Byte(MPU_CFG_REG,data1);//设置数字低通滤波器  
}
...
u8 MPU_Set_Rate(u16 rate)
{
	...
	if(rate<4)rate=4;
	data1=1000/rate-1;
	data1=MPU_Write_Byte(MPU_SAMPLE_RATE_REG,data1);	//设置数字低通滤波器
